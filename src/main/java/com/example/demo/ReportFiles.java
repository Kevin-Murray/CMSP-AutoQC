...
public class ReportFiles {
    ...
    static {
        reportMap.put(hashCode("Thermo Fusion", "N/A", "HeLa Protein Digest"), Paths.get("E:\\AutoQC-HeLa\\CMSP_Fusion_HeLa_QC-Report - Copy.csv"));
        reportMap.put(hashCode("Thermo Eclipse", "FAIMS", "HeLa Protein Digest"), Paths.get("E:\\AutoQC-HeLa\\CMSP_Eclipse_HeLa_QC-Report.csv"));
    }
